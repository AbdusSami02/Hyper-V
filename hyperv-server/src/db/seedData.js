// Source-of-truth product data. Mirrors the shape the frontend previously
// hardcoded in src/data/flavors.js, minus the bundled image import (the
// frontend maps `imageKey` back to its local asset files).
